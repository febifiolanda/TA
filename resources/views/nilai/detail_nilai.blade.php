...
<section class="content-header">
    ...
    <section class="content">
          ...
          <!-- general form elements -->
            ...
            <div class="card card-primary card-outline">
                ...
                <br>
					...
					<input  type="hidden" name="id_users" value="{{$dosen->id_users}}">
						<div class="row">
								<div class="col-md-3">                                
			...
			<div class="row">
								...
								<div class="col-md">
									<div class="form-group text-center">
										<input style="text-align:center" type="number" min="1" max="5" class="form-control required" id="skill" name="nilai[]" value="" required>
		...
		<a href="/list_nilaiAkhir" class="btn btn-primary" >Kembali</a>
    ...
    $.ajax({
      type: "POST",
        ...
        success: function(data){
            ...
            window.location = "/list_nilaiAkhir";
